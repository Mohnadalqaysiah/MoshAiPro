...
## ⚠️ يُقرأ أولاً — سجل القرارات

**[`DECISIONS.md`](DECISIONS.md)** يحوي القرارات التي لا تُستنتج من الكود:
لماذا اختير هذا دون غيره، وما البديل الذي رُفض، وأي استنتاج أُبطل بالقياس،
وأي قيد تقني يحدّ ما يمكن عمله.

- **اقرأه قبل أي تعديل** على المحرك أو حلقة رصد النتائج أو المدفوعات أو التقارير.
- **حدّثه في نفس لحظة اتخاذ القرار** — لا في نهاية العمل. قاعدة التحديث بأول الملف.
- التراجع عن قرار يُوسم ولا يُحذف؛ الاستنتاج المُبطَل يُسجَّل مع سبب بطلانه،
  وإلا أُعيد اكتشافه لاحقاً وبُني عليه من جديد.

**قيدان ساريان الآن يُعرفان قبل قراءة أي رقم أداء:**
- كل البيانات **قبل 2026-09-16** سُجّلت بحلقة رصد معطوبة — لا يُبنى عليها استنتاج استراتيجي.
- النقاط **ليست عملة موحّدة** بين الرموز (فارق المضاعف يبلغ 1200 ضعفاً) — الحكم بمضاعف R.
