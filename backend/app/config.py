...
class Settings(BaseSettings):
    ...
    # (2026-09-15) الذهب وحده كان يتطلب اتجاه HTF موافقاً صراحةً، فيُمنع
    # في السوق العرضي (RANGING) بينما بقية الرموز تحتاج فقط غياب التعارض.
    # 13% من رفضات الذهب خلال 21 يوماً كانت من هذا الشرط وحده، و11 يوماً
    # بلا أي إشارة ذهب. التعطيل هنا لا يسمح بالتعارض الصريح — بوابة
    # HTF_DIRECTION_CONFLICT تبقى نافذة. أعِده true للرجوع الفوري لسلوك
    # 18/08 بدون إعادة بناء (إعادة تشغيل الحاوية تكفي).
    XAUUSD_REQUIRE_HTF_ALIGNMENT: bool = False
