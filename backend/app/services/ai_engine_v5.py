...
class MoshAIEngineV5:
    ...
    def _get_min_rr(self) -> float:
        ...
        # (2026-09-10) محاكاة قراءة-فقط (n=74 قرار محسوم، منذ 2026-08-18) فحصت
        # رفع هذا الرقم لـ1.3/1.5 — النتيجة عكسية: expectancy/قرار ساء من
        # -12.18 إلى -13.32 (1.3) و-14.39 (1.5). فئة RR 1.0-1.3 كانت الأفضل
        # أداءً (winrate=57.1%, n=7) مقابل RR>1.8 (winrate=22.9%, n=48) —
        # عكس الافتراض الأولي. لا تُغيّر هالرقم بدون محاكاة مشابهة على عينة
        # أكبر (n≥100) — راجع backend/analyze_min_rr_simulation.py.
        return 1.0
