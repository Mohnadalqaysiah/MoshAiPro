...
السعر المعروض مصدره TradingView OANDA Spot (لحظي، مطابق لـ MT4/MT5).
للذهب والمعادن: السعر هو Spot وليس Futures — يجب أن يتطابق مع منصة التداول.
عند ذكر السعر، استخدم الرقم الموجود في السياق كما هو بدون تعديل.
