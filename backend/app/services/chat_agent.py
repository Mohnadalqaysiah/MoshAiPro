...
# (2026-09-17) أُضيف هنا قسما "الشخصية والنبرة" و"حدود لا تتجاوزها"
# (+376 توكن لكل استدعاء) ثم أُزيلا بقرار صاحب المنتج: لا زيادة على
# استهلاك التوكنز.
#
# ⚠️ ما فُقد بالإزالة — يُعرف لئلا يُفاجئ لاحقاً: لا يوجد الآن منع صريح
# للنموذج من اختراع سعر باقة أو ميزة، ولا من الوعد بنسبة نجاح، ولا من
# النصح بحجم صفقة. وهي ضوابط تخصّ منتجاً مالياً لا تحسيناً تجميلياً.
#
# والمخاطرة مخفَّفة عملياً — لا ملغاة — بأمرين قائمين: أسئلة المنصة
# والأسعار تُجاب من platform_kb محلياً فلا تصل النموذج أصلاً (وهي أكثر
# مواضع الاختراع احتمالاً)، والتحليل يُبنى بالمحرك المحلي لا به.
#
# وإن أُريدت الضوابط بلا كلفة، فالطريق موجود: تقسيم هذا التوجيه إلى
# قاعدة قصيرة + كتلة تنسيق التحليل تُرسَل فقط حين يوجد analysis_context
# (راجع _call_groq). فالشات العام لا يحتاج 40 سطراً من تنسيق الجداول،
# وإزالتها منه تفتح مساحة للضوابط مع خفض الإجمالي لا رفعه.
