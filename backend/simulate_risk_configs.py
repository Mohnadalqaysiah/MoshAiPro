...
CONFIGS = [
    ...
    # (2026-09-17 #2) عتبات استبعاد **منخفضة جداً**. الاختبارات السابقة
    # جرّبت 0.30% و0.50% فحذفت ثلثَي الإشارات وأضرّت — لكنها لم تختبر
    # النطاق الذي يهمّ فعلاً. بلاغ حقيقي: EUR/USD بوقف 2.6 نقطة (0.023%)
    # ضرب الوقف، وهو **ضِعف السبريد فقط** — أي صفقة خاسرة بنيوياً لحظة
    # إصدارها. عتبة عند 0.08% تحذف هذه الشواذّ وحدها وتُبقي الباقي،
    # وهو تدخّل مختلف نوعياً عن حذف الثلثين لا مجرد رقم أصغر.
    {"name": "استبعاد وقف <0.05%",             "min_sl_pct": 0.05, "mode": "reject", "tp1_r": 1.0, "tp2_r": 2.0, "be_at": None},
    {"name": "استبعاد وقف <0.08%",             "min_sl_pct": 0.08, "mode": "reject", "tp1_r": 1.0, "tp2_r": 2.0, "be_at": None},
    {"name": "استبعاد وقف <0.12%",             "min_sl_pct": 0.12, "mode": "reject", "tp1_r": 1.0, "tp2_r": 2.0, "be_at": None},
    {"name": "استبعاد <0.08% + تأمين 0.50R",   "min_sl_pct": 0.08, "mode": "reject", "tp1_r": 1.0, "tp2_r": 2.0, "be_at": 0.50},
